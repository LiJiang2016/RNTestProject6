  ...
  renderPage() {
    ...
    return (
      <ScrollView style={{flex: 1}}>
        ...
        >
          <Image style={{width, height: 238}} resizeMode='cover' source={require('../images/kc1.jpg')}/>
          <Image style={{width, height: 238}} resizeMode='cover' source={require('../images/kc2.jpg')}/>
          <Image style={{width, height: 238}} resizeMode='cover' source={require('../images/kc3.jpg')}/>
        </Carousel>
